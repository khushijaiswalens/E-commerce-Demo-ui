...
const LogoSlider = () => {
  ...
  const images = [
    { src: '/src/assets/logo1.png', alt: 'Image 1' },
    { src: '/src/assets/logo2.png', alt: 'Image 2' },
    { src:'/src/assets/logo3.png', alt: 'Image 3' },
    { src:'/src/assets/logo4.png', alt: 'Image 3' },
    { src:'/src/assets/logo5.png', alt: 'Image 3' },
  ];
